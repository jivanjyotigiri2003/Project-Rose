  ...
  return (
    <Fade direction="up" triggerOnce="true" delay="50">
      <div className=" lg:flex lg:flex-row flex md:flex-row flex-col-reverse ">
        <div className="flex flex-col  items-start md:w-[50vw] lg:w-[50%] p-[1rem] md:p-[2rem] lg:p-[1rem]  lg:pb-4  lg:pl-2.5 lg:pr-12">
          <h1 className="transition ease-in-out delay-150  font-[500] lg:text-[2rem] tracking-wide pb-[3rem] hover:underline underline-offset-5 md:pl-6">
            {data}
          </h1>
