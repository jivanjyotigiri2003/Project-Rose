...
function ProfileCard({designation}) {
  return (
    <div className=" w-[165px] md:w-[320px] lg:w-[300px] xl:w-[350px]  h-[360px] md:h-[600px] lg:h-[700px]  rounded-md overflow-hidden flex flex-col ">
    <div className="bg-[#fffceb] h-[30%] lg:h-[25%] rounded-xl flex items-center justify-center">
      <h1
        className={
    ...
    <div className="rounded-xl  h-[70%] bg-[#A4161A] mx-1 lg:mx-2 -mt-14">
      <img
      ...
      <div className="bg-[#FFFFFF] rounded-md my-2 md:my-5 lg:my-7 mx-1  lg:p-3 lg:mx-2 flex items-center">
        <IoCall className="text-[#A4161A]  mx-1 2xl:mx-8 text-xs md:text-3xl lg:text-xl" />
        <a
          href="tel:+4733378901"
      ...
      <div className="bg-[#FFFFFF] rounded-md  mx-1 lg:my-5 lg:p-3 2xl:mx-5 flex items-center justify-evenly">
        ...
        <a
          ...
          className="text-[#A4161A]  text-xs md:text-2xl lg:text-xl xl:text-2xl"
        >
          sdbjwbij@gmail.com
        </a>
      </div>
