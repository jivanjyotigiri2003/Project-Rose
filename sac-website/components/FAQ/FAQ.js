        ...
        <div className='w-full md:w-4/5 h-[70vh] '>
          {questions.map((q, index) => (
            <div key={index} className="shadow-xl m-3.5 flex-col text-white">
              <div className={`bg-[#850101] p-3.5 transition-all duration-200 hover: cursor-pointer ${index === openQuestionIndex ? "rounded-t-md" : "rounded-md"}` } onMouseOver={() => handleQuestionClick(index)}>
