...
export default function SocietyRepresentative() {
  ...
  const representative=[
    {officialsImage:"https://ik.imagekit.io/tvfucug8t/offimg.jpg?ik-sdk-version=javascript-1.4.3&updatedAt=1678449462704",name:"John Doe",designation:"President"},
    {officialsImage:"https://ik.imagekit.io/tvfucug8t/offimg.jpg?ik-sdk-version=javascript-1.4.3&updatedAt=1678449462704",name:"John Doe",designation:"President"},
    {officialsImage:"https://ik.imagekit.io/tvfucug8t/offimg.jpg?ik-sdk-version=javascript-1.4.3&updatedAt=1678449462704",name:"John Doe",designation:"President"},
    {officialsImage:"https://ik.imagekit.io/tvfucug8t/offimg.jpg?ik-sdk-version=javascript-1.4.3&updatedAt=1678449462704",name:"John Doe",designation:"President"},
    {officialsImage:"https://ik.imagekit.io/tvfucug8t/offimg.jpg?ik-sdk-version=javascript-1.4.3&updatedAt=1678449462704",name:"John Doe",designation:"President"},
    ...
    <div className='w-screen h-[100vh] max-[500px]:h-[65vh] '>
      <h1 className='w-[100%] h-[7%] text-[2vw] font-[600] '>Sac Officials</h1>
       ...
       {representative.map((item,index)=>{
            ...
            <div key={index} className="h-[20rem]  flex flex-col justify-center items-center m-[2rem] border-2 border-solid border-indigo-500"  >
             <div 
              className='w-[15rem] h-[15rem]   rounded-[100%]  mb-[1rem] drop-shadow-xl'
              >
