          ...
          <div className="flex flex-col  pr-4  ">
            ...
            <div className=" grid gap-4 lg:gap-10 grid-cols-2  lg:grid-cols-4  mx-1">
              <button
                className={`${
                  active == 1
                    ? "shadow-xl h-[10vh] md:h-[5vh] lg:h-[10vh]   rounded-xl p-3 text-xs  xl:text-xl lg:text-md  md:text-md  hover:bg-white hover:text-black bg-red-600 text-white"
                    : "shadow-xl rounded-xl p-3 h-[10vh] md:h-[5vh] lg:h-[10vh] bg-white hover:bg-red-600 hover:text-black text-xs  xl:text-xl lg:text-sm md:text-lg hover:scale-105 hover:transition duration-200"
                }`}
                onClick={() => {
