    ...
    <div className="h-screen w-screen flex ">
      ...
      {socData.map((soc,index)=>(
            ...
            <div className="w-[25%]  h:text-[5vw] h:shadow-lg" key={index}>
             <Link href={`/societies/${soc.name}`}><h1 className="absolute h-[100%] w-[25%] p-[1rem] top-[40%] text-[3vw] text-vertical z-100 text-white text-center h:text-underline " >{soc.name} </h1> 
            </Link>
